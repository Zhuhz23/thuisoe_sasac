...
# --- 动态、可靠的文件路径设置 ---
# 获取当前脚本文件(1_中央企业分析.py)的绝对路径
SCRIPT_PATH = os.path.abspath(__file__)
# 获取该脚本所在的目录 (your_project_folder/pages/)
SCRIPT_DIR = os.path.dirname(SCRIPT_PATH)
# 从脚本目录返回到项目根目录 (your_project_folder/)
PROJECT_ROOT = os.path.dirname(SCRIPT_DIR)
# 构建中央企业数据文件的绝对路径
CENTRAL_DATA_PATH = os.path.join(PROJECT_ROOT, 'data', 'data_central.xlsx')
...
if check_password():       
    # 采用全新的两步调用方式
    df_raw = get_raw_df_from_excel(CENTRAL_DATA_PATH)
